//
//  YourMusicTunerDetailViewController.swift
...
class YourMusicTunerDetailViewController: UIViewController {
    ...
    private func configureCollectionView() {
        datasource = UICollectionViewDiffableDataSource(collectionView: collectionView, cellProvider: { collectionView, indexPath, item in
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "YourMusicTunerDetailCell", for: indexPath) as? YourMusicTunerDetailCell else { return nil }
